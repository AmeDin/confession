				...
				<div className="col-12 mt-3">
					...
					<div className="demoWrapper">
						...
						<div className="content" ref={ div => this.content = div }>
                            ...
                            <h2 ref={ h2 => this.line9 = h2 }>Shall we start a new era?</h2>
                            <h2 ref={ h2 => this.line10 = h2 }>With me and you, Ella.</h2>
						...
						<div className="endingContent" ref={ div => this.endingContent = div }>
							...
							<h2 ref={ h2 => this.endline1 = h2 }>At present, acquainted we may be.</h2>
                            <h2 ref={ h2 => this.endline2 = h2 }>Would you still give me the opportunity.</h2>
                            <h2 ref={ h2 => this.endline3 = h2 }>To break this boundary.</h2>
                            <h2 ref={ h2 => this.endline4 = h2 }>And start making memory.</h2>
                            <h2 ref={ h2 => this.endline5 = h2 }>That will last for eternity.</h2>
                            <h2 ref={ h2 => this.endline6 = h2 }>I like you, so lets continue dating?</h2>
                            <h2 ref={ h2 => this.endline7 = h2 }>There's no need to hurry.</h2>
                            <h2 ref={ h2 => this.endline8 = h2 }>I can wait until you are ready.</h2>
                            <h2 ref={ h2 => this.endline9 = h2 }>We can start slow by keeping each other company.</h2>
                            <h2 ref={ h2 => this.endline10 = h2 }>I will always be waiting faithfully.</h2>
                            <h2 ref={ h2 => this.endline11 = h2 }>Until the day you would be mine literally.</h2>
