				...
				<div className="col-12 mt-3">
					...
					<div className="demoWrapper">
						...
						<div className="content" ref={ div => this.content = div }>
							...
							<h2 ref={ h2 => this.line1 = h2 }>Happy Birthday Begum!.</h2>
                            ...
                            <h2 ref={ h2 => this.line9 = h2 }>The original is also watchable in the next page too.</h2>
                            <h2 ref={ h2 => this.line10 = h2 }>But first watch the top one followed by the bottom one, and put yourself in my shoe</h2>
                            <h2 ref={ h2 => this.line11 = h2 }>Afterall, Its base of a story thats true</h2>
                            <h2 ref={ h2 => this.line12 = h2 }>Enjoy, woooo!</h2>
